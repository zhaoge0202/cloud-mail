const zh = {
    ...
    filterEndTime: '结束时间',
    batchDelete: '批量删除',
    batchDelUsersConfirm: '确认删除选中的 {count} 个用户吗？',
    ...
    addSmtp2goTokenDesc: '输入 SMTP2GO API Key，不填则删除',
    addOsDomain: '添加域名',
    domainDesc: '域名',
    ...
    resendTokenList: 'Resend Token 列表',
    smtp2goTokenList: 'SMTP2GO Token 列表',
    domain: '域名',
    optional: '可选',
