const en = {
    ...
    batchDelUsersConfirm: 'Delete {count} selected users?',
    ...
    addSmtp2goTokenDesc: 'Input SMTP2GO API Key; leave empty to delete.',
    ...
    resendTokenList: 'Resend Token List',
    smtp2goTokenList: 'SMTP2GO Token List',
    domain: 'Domain',
    optional: 'Optional',
